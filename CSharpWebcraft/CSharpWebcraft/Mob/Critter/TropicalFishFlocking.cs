...
public static class TropicalFishFlocking
{
    private const float NeighborRadius = 5f;
    ...
    private const float CohesionWeight = 0.06f;

    public static void Update(List<TropicalFishCritter> fish)
    {
